    ...
    int       nCmdShow)
{
    ...
    return CytwosPlayer::createAndRun();
}

int CytwosPlayer::createAndRun(void)
{
    CytwosPlayer *host = CytwosPlayer::sharedInstance();
    int ret = host->run();
    CytwosPlayer::purgeSharedInstance();
    return ret;
}

CytwosPlayer *CytwosPlayer::s_sharedInstance = NULL;

CytwosPlayer *CytwosPlayer::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new CytwosPlayer();
    }
    return s_sharedInstance;
}

void CytwosPlayer::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
CytwosPlayer::CytwosPlayer(void)
: m_app(NULL)
, m_hwnd(NULL)
, m_exit(TRUE)
...
int CytwosPlayer::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "cytwos-player");
...
void CytwosPlayer::loadProjectConfig(void)
{
    vector<string> args;
...
void CytwosPlayer::createViewMenu(void)
{
...
void CytwosPlayer::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void CytwosPlayer::updateWindowTitle(void)
{
}

void CytwosPlayer::relaunch(void)
{
...
void CytwosPlayer::writeDebugLog(const char *log)
{
...
// menu callback
void CytwosPlayer::onFileOpenProject(void)
{
...
void CytwosPlayer::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"CytwosPlayer");
...
void CytwosPlayer::onFileProjectConfig(void)
{
...
void CytwosPlayer::onFileRelaunch(void)
{
    relaunch();
}

void CytwosPlayer::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void CytwosPlayer::onViewChangeFrameSize(int viewMenuID)
{
...
void CytwosPlayer::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void CytwosPlayer::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void CytwosPlayer::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT CytwosPlayer::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    CytwosPlayer *host = CytwosPlayer::sharedInstance();
...
INT_PTR CALLBACK CytwosPlayer::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
